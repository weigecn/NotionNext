...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '李伟', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '更自由，更富有，更善良……', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://diyinian.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '第一年, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'admin@51xue.cc', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/liwei66', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/liwei_1', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://www.xiaohongshu.com/user/profile/56790d33b8ce1a239906633f', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  WIDGET_PET_LINK:
    process.env.NEXT_PUBLIC_WIDGET_PET_LINK || 'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
